...
class HomeHardcoreBot extends StatefulWidget {
  const HomeHardcoreBot({Key? key}) : super(key: key);
  static const routeName = '/MyHomeHardcoreBot';

  @override
  _HomeHardcoreBotState createState() => _HomeHardcoreBotState();
}

class _HomeHardcoreBotState extends State<HomeHardcoreBot> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Rock Paper Scissors With HardcoreBot')),
      body: Container(
